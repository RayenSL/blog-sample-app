    ...
    return (
        <div className='max-w-sm bg-white shadow-lg'>
            <div className='relative'>
                ...
                />
                <div>
                    <p className='absolute left-3 italic text-xs top-20 text-white'>{new Date(props.blogItem.created_at).toLocaleDateString()}</p>
                </div>
                <div>
                    <p className='absolute right-3 italic text-xs top-20 text-white'>{props.blogItem.category.name}</p>
                </div>
            </div>
